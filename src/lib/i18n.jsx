...
const dictionaries = {
  en: {
    ...
    home: {
      ...
      collectionsSub: 'Same mood swings, different outfit. Ekhtar wa7ad w khalas.',
      newDropEyebrow: 'Autumn complaints drop',
      newDropTitle: 'New drop — open for preorder',
      newDropSub: 'El preorder bisakker Sep 15. Shipping akher September — enno ya3ni, iza el balad radit.',
      noDropEyebrow: 'Kharbesh Drops',
      noDropTitle: 'Nothing\u2019s brewing right now',
      noDropSub: 'Halla2 n7na bein jomle w jomle. Taba3na — li byetesajjal awwal, bye5od el drop el jeye awwal.',
    ...
    product: {
      ...
      chooseFit: 'Choose fit',
      fitNote: 'Same tee, two cuts — regular is true to size, oversize is boxier and longer. Same price either way.',
      quantity: 'Quantity',
  ...
  ar: {
    ...
    product: {
      ...
      chooseFit: 'اختر القصّة',
      fitNote: 'نفس التيشيرت، قصّتين — العادية على قدّك، والأوفرسايز أوسع وأطول. نفس السعر.',
      quantity: 'الكمية',
      addToCart: 'أضف للسلة',
      ...
      preorderNote: 'هاد طلب مسبق. بتحجز قطعة جاهزة — مننتج بعد ما تقفل النافذة.',
      perUnit: '/ القطعة',
    ...
    faq: {
      title: 'أسئلة شائعة',
      items: [
        { q: 'شو هو الطلب المسبق؟', a: 'بتحجز قطعة قبل ما نطبع. بعد ما تقفل نافذة الطلب، منطلب القماش ومنطبع. بتوصلك معلومات التتبع أول ما تشحن.' },
