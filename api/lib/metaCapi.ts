...
//
// Everything is env-driven (KHARBESH_META_PIXEL_ID / KHARBESH_META_CAPI_ACCESS_TOKEN
// / KHARBESH_META_TEST_EVENT_CODE) and degrades to a safe no-op when the token
